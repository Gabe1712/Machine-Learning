...
train_X,valid_X,train_label,valid_label = train_test_split(x_train, train_Y_one_hot, test_size=0.1, random_state=250)
train_X, train_label = smote.fit_resample(train_X, train_label)
